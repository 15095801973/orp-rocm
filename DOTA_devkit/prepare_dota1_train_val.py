...
def prepare_multi_scale_data(src_path, dst_path, gap=200, subsize=1024, scales=[0.5, 1.0, 1.5], num_process=32):
    ...
    split_train = splitbase_trainval(osp.join(src_path, ''), dst_train_path,
...
if __name__ == '__main__':
    ...
    # single scale
    prepare_multi_scale_data('/home/lingrui/art/OrientedRepPoints/data/ddata/part1',
                             '/home/lingrui/art/OrientedRepPoints/data/dota_1024_train_val',scales=[1.0])
    print('done')
